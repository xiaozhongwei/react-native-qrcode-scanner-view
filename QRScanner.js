...
export default class QRScannerView extends Component {
  ...
  componentDidMount(){
    this.tryRequestCameraPermission();
  ...
  tryRequestCameraPermission = async () => {
  ...
  cameraWrapper = ({ children, permissionGranted, torchOn, userFront }) => {
  ...
  render() {
    ...
    const CameraWrapper = this.cameraWrapper;
